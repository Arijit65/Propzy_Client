        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center space-x-3">
              <button className="p-2 hover:bg-purple-500 rounded-full transition" aria-label="Notifications">
                <Bell className="w-5 h-5" />
              </button>
              <div className="flex items-center space-x-2 cursor-pointer hover:bg-purple-500 px-3 py-1.5 rounded transition">
                <div className="flex items-center justify-center w-8 h-8 bg-green-400 rounded-full font-bold text-blue-900 text-sm">
                  RM
                </div>
                <ChevronDown className="w-4 h-4" />
              </div>
              <button className="p-2 hover:bg-purple-500 rounded transition" aria-label="Menu">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              <div className="flex items-center space-x-4">
                <div className="relative w-20 h-20">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-xl font-bold text-gray-900">{propertyScore}%</span>
                  </div>
                </div>
                <div>
                  <h3 className="font-bold text-gray-900 text-sm">Property Score</h3>
          ...
          <div className="lg:col-span-3">
              ...
              <AnimatePresence mode="wait">
                ...
                {currentStep === 1 && (
                  ...
                  >
                    ...
                    <p className="text-base text-gray-900 mb-8">Fill out basic details</p>
                    ...
                    <motion.button
                      ...
                      className="bg-purple-600 text-white px-8 py-2.5 rounded font-semibold hover:bg-purple-700 transition-colors text-sm"
                    >
                      Continue
                    </motion.button>
                  </motion.div>
                ...
                {currentStep === 2 && (
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <label className="block text-gray-900 font-medium mb-2 text-sm">Locality</label>
                        <input
                          type="text"
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={handleContinue}
                      className="mt-8 bg-purple-600 text-white px-8 py-2.5 rounded font-semibold hover:bg-purple-700 transition-colors text-sm"
                    >
                      Continue
                    </motion.button>
                  </motion.div>
                ...
                {currentStep === 3 && (
                  ...
                  >
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-8">Tell us about your property</h2>

                    <div className="space-y-8">
                      {/* Add Room Details */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-4">Add Room Details</h3>
                        ...
                        <div className="mb-4">
                          ...
                          <button className="mt-2 text-purple-600 text-sm font-medium hover:underline flex items-center bg-transparent border-0 p-0">
                      ...
                      {/* Add Area Details */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">Add Area Details</h3>
                        ...
                        <div className="mt-3 flex gap-4">
                          <button className="text-purple-600 text-sm font-medium hover:underline flex items-center bg-transparent border-0 p-0">
                      ...
                      {/* Floor Details */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-4">Floor Details</h3>
                      ...
                      {/* Age of Property */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-4">Age of property</h3>
                        <div className="flex flex-wrap gap-3">
                      ...
                      <div>
                        ...
                        <button className="mt-3 text-purple-600 text-sm font-medium hover:underline flex items-center bg-transparent border-0 p-0">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">What makes your property unique</h3>
                ...
                {currentStep === 4 && (
                  ...
                  >
                    <div className="flex justify-between items-start mb-6">
                      ...
                      <button className="text-purple-600 hover:text-purple-700 font-medium text-sm">Close X</button>
                    </div>

                    <h2 className="text-2xl font-bold text-gray-900 mb-2">Add one video of property</h2>
                    <p className="text-gray-600 mb-4">
                      A video is worth a thousand pictures. Properties with videos get higher page views
                    </p>
                    <p className="text-sm text-gray-600 mb-6">
                      Make sure it follows the <a href="#" className="text-purple-600 hover:underline">Video Guidelines</a>
                    </p>
                ...
                {currentStep === 5 && (
                  ...
                  >
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">Add amenities/unique features</h2>
                    <p className="text-gray-600 mb-6">
                    ...
                    <div className="space-y-8">
                      {/* Other Rooms */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">Other rooms <span className="text-gray-500 font-normal">(Optional)</span></h3>
                        <div className="flex flex-wrap gap-3">
                      ...
                      {/* Furnishing */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">Furnishing <span className="text-gray-500 font-normal">(Optional)</span></h3>
                        <div className="flex gap-4">
                      ...
                      {/* Reserved Parking */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">Reserved Parking <span className="text-gray-500 font-normal">(Optional)</span></h3>
                      ...
                      <div>
                        ...
                        <button className="mt-3 text-purple-600 text-sm font-medium hover:underline bg-transparent border-0 p-0">7 more +</button>
                      </div>

                      {/* Society/Building Feature */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-3">Society/Building feature</h3>
                        <div className="flex flex-wrap gap-3">
                      ...
                      {/* Water Source */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-3">Water Source</h3>
                        <div className="flex flex-wrap gap-3">
                      ...
                      {/* Overlooking */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-3">Overlooking</h3>
                        <div className="flex flex-wrap gap-3">
                      ...
                      {/* Other Features */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-3">Other Features</h3>
                        <div className="space-y-2">
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                      ...
                      {/* Power Back up */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-3">Power Back up</h3>
                        <div className="flex gap-4">
                      ...
                      {/* Property Facing */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-3">Property facing</h3>
                        <div className="flex flex-wrap gap-3">
                      ...
                      {/* Type of Flooring */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-3">Type of flooring</h3>
                        <select
                      ...
                      {/* Location Advantages */}
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">Location Advantages</h3>
                    ...
                    <div className="mt-8 bg-purple-50 border border-purple-200 rounded-lg p-4 flex items-start">
                      <div className="text-purple-600 mr-3 mt-0.5">💡</div>
                      <div>
                        <p className="text-sm text-gray-900">
                          <span className="font-semibold">You can change your Top USPs from here</span>
                          <br />
                          Or see your current top USPs{' '}
                          <button className="text-purple-600 hover:underline font-medium bg-transparent border-0 p-0">click here</button>
                        </p>
                      </div>
                    </div>
            ...
            >
              <div className="inline-block bg-white rounded-lg shadow-sm border border-gray-200 p-3">
                <div className="flex items-start space-x-2">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-gray-700">
                      You can email us at{' '}
                      <a href="mailto:support@propszy.com" className="text-purple-600 font-semibold hover:underline">
                        support@propszy.com
                      </a>
                    </p>
                    <p className="text-xs text-gray-700">
                      or call us at{' '}
                      <a href="tel:18001234567" className="text-purple-600 font-semibold hover:underline">
                        1800 123 4567
                      </a>{' '}
