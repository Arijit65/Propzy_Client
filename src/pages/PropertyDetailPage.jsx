        ...
        <div className="space-y-6">
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="bg-purple-600 text-white px-3 py-1 rounded text-xs font-semibold">
                      REGISTERED
                    </span>
                  </div>
                  <h1 className="text-2xl font-bold text-gray-900 mb-1">{formattedProperty.title}</h1>
              ...
              <div className="mb-6 pb-6 border-b">
                <div className="flex items-baseline gap-2 mb-1">
                  <span className="text-3xl font-bold text-gray-900">{formattedProperty.price}</span>
                  <span className="text-lg text-gray-600">{formattedProperty.pricePerSqft}</span>
                </div>
                <p className="text-sm text-gray-600 mb-2">
                  Estimated EMI <span className="font-semibold text-gray-900">{formattedProperty.estimatedEMI || 'Calculate'}</span>
                </p>
            ...
            >
              ...
              <div className="space-y-12">
                ...
                <div ref={overviewRef} id="overview" className="scroll-mt-24 space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">{formattedProperty.superBuiltArea}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900 text-sm">{formattedProperty.bedrooms || 'N/A'} Bedrooms, {formattedProperty.bathrooms || 'N/A'} Bathrooms, {formattedProperty.balconies || 'N/A'} Balconies</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900 text-sm">{formattedProperty.location}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">{formattedProperty.facing}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900 text-sm">{formattedProperty.floorNumber}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">{formattedProperty.availableFrom}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* About Property */}
                  <div>
                    <h3 className="text-lg font-bold text-gray-900 mb-3">About Property</h3>
                ...
                <div ref={societyRef} id="society" className="scroll-mt-24 space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center py-2 border-b">
                      ...
                      <span className="text-sm font-semibold text-gray-900">{formattedProperty.transactionType || 'N/A'}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b">
                      <span className="text-sm text-gray-600">Ownership</span>
                      <span className="text-sm font-semibold text-gray-900">{formattedProperty.ownership}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b">
                      <span className="text-sm text-gray-600">Gated community</span>
                      <span className="text-sm font-semibold text-gray-900">{formattedProperty.gatedSociety ? 'Yes' : 'No'}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b">
                      <span className="text-sm text-gray-600">Carpet Area</span>
                      <span className="text-sm font-semibold text-gray-900">{formattedProperty.carpetArea}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b">
                      <span className="text-sm text-gray-600">Pet Friendly</span>
                      <span className="text-sm font-semibold text-gray-900">{formattedProperty.petFriendly ? 'Yes' : 'No'}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b">
                      <span className="text-sm text-gray-600">Parking</span>
                      <span className="text-sm font-semibold text-gray-900">{formattedProperty.parking}</span>
                    </div>
                  </div>
                </div>
                ...
                <div ref={dealerRef} id="dealer" className="scroll-mt-24 space-y-6">
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="md:w-1/3">
                      <h3 className="text-lg font-bold text-gray-900 mb-4">Dealer Details</h3>
                      <div className="flex items-start gap-3 mb-4">
                        ...
                        <div>
                          <button className="bg-purple-600 text-white px-4 py-1 rounded text-sm font-semibold hover:bg-purple-700 mb-2">
                            View Phone Number
                          </button>
                      ...
                      <div className="space-y-3 text-sm">
                        <div>
                          <h4 className="text-purple-600 font-semibold mb-1">{formattedProperty.owner.name}</h4>
                          <p className="text-gray-600">Real Estate / Property Private Limited</p>
                        </div>

                        <div>
                          <p className="font-semibold text-gray-900 mb-1">Properties Listed: {formattedProperty.owner.properties || 'N/A'}</p>
                        </div>
                        ...
                        <div>
                          <p className="text-gray-600"><strong>Website:</strong> <a href="#" className="text-purple-600 hover:underline">{formattedProperty.owner.website || 'N/A'}</a></p>
                        </div>
                      </div>
                    </div>
                ...
                <div ref={priceRef} id="price" className="scroll-mt-24 space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-semibold text-gray-900">{formattedProperty.priceInsights?.priceChangeText || 'N/A'}</p>
                      ...
                      <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-semibold text-gray-900">{formattedProperty.priceInsights?.priceRangeText || 'N/A'}</p>
                  ...
                  {/* Price Trend Chart */}
                  <div>
                    <h3 className="text-lg font-bold text-gray-900 mb-4">Price Trend & Comparison</h3>
                    <div className="flex gap-4 mb-4">
                      <button className="px-4 py-2 bg-white border-b-2 border-purple-600 text-purple-600 font-semibold">
                        With Locality
                      </button>
                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-between mb-2">
                        <p className="text-2xl font-bold text-gray-900">₹ 15,000 <span className="text-sm font-normal">/ sq.ft</span></p>
                      ...
                      <div className="relative h-48 bg-gradient-to-t from-purple-100 to-transparent rounded-lg border border-gray-200 p-4">
                    ...
                    <div className="border rounded-lg overflow-hidden">
                      <div className="bg-gray-50 px-4 py-3 font-semibold text-sm text-gray-900 border-b flex items-center justify-between">
                        <span>CURRENTLY COMPARING</span>
                        <button className="text-purple-600 text-xs hover:underline flex items-center gap-1">
                    ...
                    {/* CTA Banner */}
                    <div className="mt-6 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-6 text-white flex items-center justify-between">
                ...
                <div ref={reviewsRef} id="reviews" className="scroll-mt-24 space-y-6">
                  <div>
                    <h3 className="text-lg font-bold text-gray-900 mb-2">Society Reviews</h3>
                    <p className="text-sm text-gray-600 mb-6">{formattedProperty.location.split(',')[0]} Ratings and Reviews</p>

                    {/* No Reviews State */}
                    <div className="text-center py-12">
                      <div className="w-24 h-24 mx-auto mb-4 bg-purple-50 rounded-full flex items-center justify-center">
                        <MessageSquare className="w-12 h-12 text-purple-400" />
                      </div>
                      <h4 className="text-lg font-semibold text-gray-900 mb-2">Review this Society</h4>
                ...
                {formattedProperty.similarProperties && formattedProperty.similarProperties.map((prop) => (
                  ...
                  >
                    ...
                    <div className="p-3 bg-white">
                      <p className="font-bold text-gray-900 mb-1">{prop.price}, {prop.title}</p>
                      <p className="text-xs text-gray-600 mb-1">{prop.subtitle}</p>
                      <p className="text-xs text-gray-500">{prop.location}</p>
                      <button className="mt-2 w-full bg-purple-600 text-white py-1.5 rounded text-xs font-semibold hover:bg-purple-700 transition">
                        Enquire Now
                      </button>
                    </div>
                  </Link>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold text-gray-900 mb-2">{formattedProperty.price}</h2>
                ...
                {formattedProperty.similarProperties && formattedProperty.similarProperties.slice(0, 5).map((prop) => (
                  ...
                  >
                    ...
                    <div className="p-2 bg-white">
                      <p className="font-semibold text-sm text-gray-900">{prop.price}, {prop.title}</p>
                      <p className="text-xs text-gray-600">{prop.subtitle}</p>
                      <p className="text-xs text-gray-500">{prop.location}</p>
                      <button className="mt-2 w-full bg-purple-600 text-white py-1 rounded text-xs font-semibold hover:bg-purple-700 transition">
                        Enquire Now
                      </button>
                    </div>
                  </Link>
            ...
            >
              <button className="inline-flex items-center gap-2 bg-purple-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-purple-700 transition">
