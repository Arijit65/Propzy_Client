                          ...
                          <button
                            ...
                            className={`px-5 py-2 rounded-full font-medium transition-all text-sm border-2 ${
                              formData.purpose === option
                                ? 'bg-blue-50 text-purple-700 border-blue-600'
                ...
                {currentStep === 5 && (
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      className="mt-8 bg-purple-600 text-white px-8 py-2.5 rounded font-semibold hover:bg-purple-700 transition-colors text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                    >
