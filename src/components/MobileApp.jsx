          ...
          >
            <div className="relative max-w-md mx-auto">
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl p-4 transform -rotate-3 hover:rotate-0 transition-transform duration-300">
                <div className="bg-gray-900 rounded-2xl overflow-hidden">
                  ...
                  <div className="bg-white">
                    {/* Status Bar */}
                    <div className="bg-blue-600 h-6"></div>
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -right-4 bg-blue-600 text-white px-6 py-3 rounded-full shadow-xl"
              >
