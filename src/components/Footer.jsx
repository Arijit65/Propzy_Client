    ...
    <footer className="bg-slate-900 text-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <motion.div
          ...
          className="mt-12 pt-8 border-t border-slate-700"
        >
          <h3 className="text-white font-bold text-lg mb-4">Download the App</h3>
        ...
        >
          ...
          <div className="flex space-x-4">
            ...
            <motion.a
              href="#"
              whileHover={{ scale: 1.2, y: -2 }}
              className="bg-slate-800 p-3 rounded-full hover:bg-blue-400 transition-colors"
              aria-label="Twitter"
            >
              <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white font-bold text-lg">Propszy</span>
            </div>
            <div className="text-gray-300 text-sm text-center md:text-left">
              All trademarks are the property of their respective owners.<br />
              All rights reserved. Propszy Real Estate Pvt. Ltd.
            </div>
            <div className="text-gray-300 text-sm font-medium">
              &copy; 2025 Propszy.com
            </div>
          </div>
        </div>
      </div>
