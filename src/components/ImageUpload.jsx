    ...
    <div className="w-full">
      ...
      <div
        className={`
          ...
          ${dragActive ? 'border-blue-500 bg-purple-50' : 'border-purple-300 bg-purple-50'}
      ...
      >
        ...
        <Upload className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-4 text-purple-400" />
        ...
        <button
          ...
          disabled={images.length >= maxImages}
          className="border-2 border-purple-600 text-purple-600 px-4 sm:px-6 py-2 rounded font-semibold hover:bg-purple-50 transition disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
        >
          Upload Photos Now
        </button>
      </div>
            ...
            <AnimatePresence>
              {images.map((image, index) => (
                <motion.div
                  ...
                  className="relative group aspect-square rounded-lg overflow-hidden border-2 border-gray-200 hover:border-purple-400 transition"
                >
                  <img
                    src={image.preview}
                    alt={`Upload ${index + 1}`}
      ...
      {images.length < 5 && (
        <div className="mt-4 bg-blue-900 text-white rounded-lg p-3 sm:p-4 flex items-start gap-2 sm:gap-3">
          <div className="bg-white rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0 mt-0.5">
            <span className="text-blue-900 font-bold text-xs sm:text-sm">!</span>
          </div>
