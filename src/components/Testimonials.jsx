  ...
  const testimonials = [
    {
      ...
      text: 'You get an exclusive RM from Propszy team who tracks your property closely.',
      rating: 5
    },
    {
      name: 'Prateek Sengar',
      ...
      text: 'Propszy has a better response rate compared to any of their competitors.',
      rating: 5
    },
    {
      name: 'SOBHA Develt.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
            What our customers are saying about Propszy
          </h2>
