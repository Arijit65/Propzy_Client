    ...
    <section className="bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                {category.links.map((link, linkIndex) => (
                  <li key={linkIndex}>
                    <motion.a
                      href="#"
                      whileHover={{ x: 5 }}
                      className={`flex items-center justify-between text-gray-700 hover:text-blue-600 transition-colors font-medium ${
                        link.startsWith('View') ? 'text-blue-600 font-semibold' : ''
                      }`}
                    >
        ...
        <motion.div
          ...
          className="mt-12 bg-blue-600 rounded-lg p-8"
        >
